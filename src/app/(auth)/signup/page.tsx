      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-2">
            ...
            <span className="text-xl font-bold text-teal-600">NutriTrack</span>
          </div>
          <p className="text-gray-400 text-sm">Start your nutrition journey today</p>
        </div>
        <Card className="shadow-lg border-0">
          <CardHeader className="pb-4">
            <CardTitle className="text-xl">Create an account</CardTitle>
            <CardDescription>Join NutriTrack and start tracking your meals</CardDescription>
          </CardHeader>
          <CardContent>
